        ...
        <div class="row mspace">
            ...
            <div class="col-md-8 text-center">
                <p class="p-para">ADMOG Holding Corp. is a leading natural resources holding company dedicated to the
                    exploration, development, and trading of natural resources. With a strategic focus on the metals
                    sector, we are committed to delivering sustainable value through innovative practices, responsible
                    resource management, and a robust trading platform.</p>
            </div>
            <div class="col-md-2"></div>
        </div>
    </div>
...
<section>
    <div class="container space-y">
        ...
        <div class="row space d-flex justify-content-around">
